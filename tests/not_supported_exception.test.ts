/**
 * This file contains tests for the NotSupportedException feature.
 *
...
describe('NotSupportedException', () => {
  describe('inheritance', () => {
    const instance = new NotSupportedException('');
  ...
  describe('(message)', () => {
    it('should create an NotSupportedException with the provided message', () => {
      messageFixtures.forEach(([message, expected]) => {
        const ex = new NotSupportedException(message);

        assert(ex instanceof NotSupportedException);
  ...
  describe('(message, {cause})', () => {
    it('should create an NotSupportedException with the provided message and cause', () => {
      messageCauseFixtures.forEach(([message, cause, expected]) => {
        const ex = new NotSupportedException(message, { cause });
  ...
  describe('(message, data)', () => {
    it('should create an NotSupportedException with the provided message and data', () => {
      messageDataFixtures.forEach(([message, data, expected]) => {
        const ex = new NotSupportedException(message, data);
  ...
  describe('(message, {cause, ...data})', () => {
    it('should create an NotSupportedException with the provided message, data, and cause', () => {
