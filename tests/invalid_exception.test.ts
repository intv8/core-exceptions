/**
 * This file contains tests for the InvalidException feature.
 *
...
describe('InvalidException', () => {
  describe('inheritance', () => {
    const instance = new InvalidException('');
  ...
  describe('(message)', () => {
    it('should create an InvalidException with the provided message', () => {
      messageFixtures.forEach(([message, expected]) => {
        const ex = new InvalidException(message);

        assert(ex instanceof InvalidException);
  ...
  describe('(message, {cause})', () => {
    it('should create an InvalidException with the provided message and cause', () => {
      messageCauseFixtures.forEach(([message, cause, expected]) => {
        const ex = new InvalidException(message, { cause });
  ...
  describe('(message, data)', () => {
    it('should create an InvalidException with the provided message and data', () => {
      messageDataFixtures.forEach(([message, data, expected]) => {
        const ex = new InvalidException(message, data);
  ...
  describe('(message, {cause, ...data})', () => {
    it('should create an InvalidException with the provided message, data, and cause', () => {
